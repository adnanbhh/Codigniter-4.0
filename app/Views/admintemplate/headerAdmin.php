          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="/category">Location</a></li>
                <li class="nav-item"><a class="nav-link" href="/addCategory">Add Location</a></li>
              </ul>
            </div>
          </li>
             ...
             if((sizeof($group))>0)
              {
                ...
                { ?>
                <li class="nav-item"> <a class="nav-link" href="/magic?id=<?= $info['ID']; ?>">Add <?= $info['Titre']; ?></a></li>
          <?php
                }
              }
              else{ ?>
